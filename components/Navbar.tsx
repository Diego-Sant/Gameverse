...
const Navbar  = () => {
    ...
    return (
        <nav className="w-full">
            <div className="px-4 md:px-16 py-3 flex sm:flex-row flex-col items-center transition duration-500" >
                <Image src="/images/gamelogo.png" className="mt-2" alt="Gameverse" width={140} height={140} priority={true} style={imageStyle} />
                <div className="sm:ml-auto ml-20">
                    <div className="flex flex-row items-center gap-4 relative sm:mt-0 mt-10">
                        ...
                        <div className="flex flex-col" onFocus={handleClick} onBlur={handleBlur}>
                            <input type="text" placeholder="Procure o jogo..." className={`bg-transparent text-white outline-none ${isClicked ? 'clicked' : ''}`} />
